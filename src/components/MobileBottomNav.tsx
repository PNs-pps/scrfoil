...
import { BarChart3, Package, Scissors, History, Settings } from 'lucide-react';
      ...
      <div className="grid grid-cols-5 items-center max-w-md mx-auto">
        ...
        <div className="flex justify-center -mt-4">
          <button
            ...
            className="w-12 h-12 rounded-full bg-amber-500 hover:bg-amber-400 text-slate-950 flex flex-col items-center justify-center shadow-md active:scale-95 transition-transform border-2 border-white cursor-pointer"
          >
            <Scissors className="w-5 h-5 stroke-[2.5]" />
            <span className="text-[9px] font-black -mt-0.5 uppercase tracking-tighter">ตัดสต๊อก</span>
          </button>
        </div>
